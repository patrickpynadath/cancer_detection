...
def config_transfer_learn_ae(args: ArgumentParser):
    ...
    args.add_argument('--latent_size', help='size of latent dim', default=200, type=int)
    args.add_argument('--learning_mode', help='task to use for training', default='normal', type=str)
    args.add_argument('--num_hiddens', help='num hiddens for resstack', default=128, type=int)
    args.add_argument('--num_residual_layers', help='num residual layers', default=10, type=int)
    args.add_argument('--num_residual_hiddens', help='num hiddens for residuals', default=32,
                                         type=int)
