#!/bin/sh
python main.py train_clf --sample_strat dynamic_ros  --learning_mode jigsaw --accelerator gpu --devices 1 --device cuda --max_epochs 1 --criterion MSFE --lr .00001  --track_grad_norm 2 --balancing_beta .5;
